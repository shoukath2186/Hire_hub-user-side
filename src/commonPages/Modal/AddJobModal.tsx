...
import LogoImage from './JobFormAssets/LogoImage';
...
const AddJobModal: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => {
    ...
    const [allType] = useState<string[]>(['Full Time', 'Remote', 'Part Time']);
    const [allSkill] = useState<string[]>(['mongodb', 'js', 'html', 'css']);



    const [errorData, setErrorData] = useState({
        companyName: '', contact: '', location: '', salary: '', title: '',
        type: '', description: '', category: '', skill: '', companyLogo: ''
    });
    //======================================================================================
    const handleSubmit = () => {
        const valid = validation({
            companyName, contact, location, salary, title, type, description, category, skill, companyLogo,
        ...
        if (valid) {
            ...
            console.log('success.');
                ...
                const formData ={
                    ...
                    category,skill:skill,logo:companyLogo
                }
            axios.post('http://localhost:3000/job/addNewJob',formData, {
                headers: {
        ...
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent sx={{ padding: '16px' }}>
                <Grid container spacing={3}>
                    ...
                    <LogoImage setCompanyLogo={setCompanyLogo} error={errorData.companyLogo} />
